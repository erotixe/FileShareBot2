...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://mehtadmphta33:Mehtab1234@cluster0.fjsngoa.mongodb.net/?retryWrites=true&w=majority")
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\nI am a file store bot Powered by @Animes_xyz.")
try:
    ADMINS=[]
